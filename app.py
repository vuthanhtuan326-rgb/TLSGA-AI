...
<div class="main-header">
    ...
    <p>Tác giả: Vũ Thanh Tuấn - Trường PTDTBT Tiểu học Đường Thượng - ĐT: 0912737867</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Vũ Thanh Tuấn - Trường PTDTBT Tiểu học Đường Thượng - ĐT: 0912737867</div>", unsafe_allow_html=True)
